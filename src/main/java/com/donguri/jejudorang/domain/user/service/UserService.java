...
public interface UserService {
    ...
    // 마이페이지: 내 작성글 목록 조회
    Page<CommunityListResponse> getMyCommunityWritings(String accessToken, Pageable pageable);

    // 마이페이지: 내가 댓글단 글 목록 조회
    Page<CommunityListResponse> getMyCommunityComments(String accessToken, Pageable pageable);
